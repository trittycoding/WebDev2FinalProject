<?php
    ...
    $query = "SELECT * FROM SoftwareCategories WHERE categoryID = :categoryID";
    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-10 col-lg-8 col-xl-7 mx-auto">
          <form method="post" action="deletesoftwarecategory.php?userID=<?=$row['categoryID']?>">
            <div class="form-row">
              <div class="col-12 col-md-4s mb-2 mb-md-0">
                <h3>Edit Software Category</h3>
                    ...
                    <label for="softwareCategory">User Category:</label>
                    <input class="form-control form-control-sm" id="softwareCategory" name="softwareCategory" readonly type="text" value="<?=$row['softwareCategory']?>"/>
