    ...
    <div class="container">
      <div class="row">
        ...
        <div class="col-md-10 col-lg-8 col-xl-7 mx-auto">
          <form method="post" action="deleteusercategory.php?userID=<?=$row['categoryID']?>">
            <div class="form-row">
              <div class="col-12 col-md-4s mb-2 mb-md-0">
                <h3>Edit User Category</h3>
                    ...
                    <input class="form-control form-control-sm" id="userCategory" name="userCategory" readonly type="text" value="<?=$row['userCategory']?>"/>
