<?php
  ...
  $query = "SELECT COLUMN_NAME FROM INFORMATION_SCHEMA.COLUMNS WHERE TABLE_SCHEMA = 'GOAT_CMS' AND TABLE_NAME = 'hardware'";
  $statement = $db->prepare($query);
  $statement->execute();

  //Query to populate the categories in the table
  $query2 = "SELECT * FROM HardwareCategories";
...
<body>
  ...
  <header class="masthead text-white text-center">
    ...
    <div class="container">
      <div class="row">
        ...
        <form method="post" action="inserthardwarecategory.php">
            <div class="form-row">
  ...
  <<table class="table table-hover table-dark">
    <tbody>
        ...
        <tr>
            <td><a href="edithardwarecategory.php?categoryID=<?=$row['categoryID']?>"><?=$row['categoryID']?></td>
